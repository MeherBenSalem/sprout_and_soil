...
public final class CropLogic {
    private static final TagKey<Block> FARMLAND_TAG = TagKey.create(Registries.BLOCK, ResourceLocation.parse("crops:farmland"));
    private static final TagKey<Item> FERTILIZER_TAG = TagKey.create(Registries.ITEM, ResourceLocation.parse("crops:fertilizer"));
