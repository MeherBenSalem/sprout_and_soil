...
public class FertilizerUsedOnSingleStage3Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_3.get()
			...
			nextStage1 = SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_4.get().defaultBlockState();
			nextStage2 = SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_5.get().defaultBlockState();
			nextStage3 = SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_6.get().defaultBlockState();
			random = Math.random();
