...
public class FertilizerUsedOnSingleStage1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_1.get()
			...
			nextStage1 = SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_2.get().defaultBlockState();
			nextStage2 = SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_3.get().defaultBlockState();
			nextStage3 = SproutAndSoilModBlocks.TOMATO_PLANT_STAGE_4.get().defaultBlockState();
			random = Math.random();
